...
import com.github.hiteshsondhi88.libffmpeg.GetPathFromUri;
 ...
 * @date 2018/10/31 11:31   2023年7月12日17:59:02
 */
...
//                }
                ...
                cmd = "-threads 4 -y -i " + mVideoPath + " -b:v 1000k -bufsize 1000k -maxrate 2500k -b:a 32k -strict -2 -vcodec libx264 -preset superfast -crf 30 -acodec copy -ac 2 " + currentOutputVideoPath;
